...
public class Cell {
    // The contents of this cell (empty, cross, nought)
    Player content;
    // Making the row and column an integers of this cell
    int row, col;

    /** Constructor to initialize this cell with the specified row and col */
    public Cell(int row, int col) {
        // Initialize the variables row and col
        this.row = row;
        this.col = col;
    ...
    public void paint(Graphics g) {
        ...
        } else if (content == Player.Noughts) {
